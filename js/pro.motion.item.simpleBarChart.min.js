...
(function(d){(function(b){(function(b){(function(b){(function(b){var e=d.Motion.Serialization,f=d.Motion.Util;b.readJson=function(c,a){var d=Math.max(1,Math.min(f.convertToNumber(f.getSetup(a,"bars")),100)),k=Math.max(0,f.convertToNumber(f.getSetup(a,"width"),50)),u=Math.max(0,f.convertToNumber(f.getSetup(a,"height"),50)),g=Math.max(0,f.convertToNumber(f.getSetup(a,"margin"),1)),l=0,n=0,h=f.getSetup(a,"domain");"number"===typeof h?n=h:h instanceof Array&&(l=0<h.length?f.convertToNumber(h[0]):0,n=
1<h.length?f.convertToNumber(h[1]):0);n<l&&(h=n,n=l,l=h);var p=b.Props.getPropertyTypes(),m=b.Props.getBarPropertyTypes(),h=e.PropertyListReader.read(c.story,a.init,p),v=e.PropertyListReader.read(c.story,a.barInit||a.barsInit,m),p=e.ScriptSetReader.readJson(c,"Chart",a,[""],p),m=e.ScriptSetReader.readJson(c,"Bars",a,["bar","bars"],m);return new b.Extension(c,d,k,u,g,l,n,h,p,v,m)}})(b.simpleBarChart||(b.simpleBarChart={}))})(b.Items||(b.Items={}))})(b.Extensions||(b.Extensions={}))})(d.Motion||(d.Motion=
{}))})(Pro||(Pro={}));
